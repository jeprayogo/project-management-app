                    ...
                    <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                        <form onSubmit={onSubmit} className="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rouded-lg">
                            <div>
                                ...
                                <SelectInput name="project_id" id="task_project_id" className="mt-1 bock w-full" onChange={(e) => setData("project_id", e.target.value)}>
                            ...
                            <div className="mt-4">
                                ...
                                <SelectInput name="priority" id="task_priority" className="mt-1 bock w-full" onChange={(e) => setData("priority", e.target.value)}>
                            ...
                            <div className="mt-4">
                                ...
                                <SelectInput name="assigned_user_id" id="task_assigned_user_id" className="mt-1 bock w-full" onChange={(e) => setData("assigned_user_id", e.target.value)}>
                            ...
                            <div className="mt-4">
                                ...
                                <SelectInput name="status" id="task_status" className="mt-1 bock w-full" onChange={(e) => setData("status", e.target.value)}>
