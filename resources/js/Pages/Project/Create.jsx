                    ...
                    <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                        <form onSubmit={onSubmit} className="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rouded-lg">
                            ...
                            <div className="mt-4">
                                ...
                                <TextInput id="project_name" type="text" name="name" className="mt-1 block w-full" value={data.name} isFocused={true} onChange={(e) => setData('name', e.target.value)} />
                                <InputError message={errors.name} className="mt-2" />
                            </div>
                            <div className="mt-4">
                                <InputLabel htmlFor="project_description" value="Project Project Description" />
                            ...
                            <div className="mt-4">
                                ...
                                <TextInput id="project_due_date" type="date" name="due_date" className="mt-1 block w-full" value={data.due_date} onChange={(e) => setData('due_date', e.target.value)} />
                                <InputError message={errors.due_date} className="mt-2" />
                            </div>
                            <div className="mt-4">
                                <InputLabel htmlFor="project_status" value="Project Status" />
                                <SelectInput name="status" id="project_status" className="mt-1 bock w-full" onChange={(e) => setData("status", e.target.value)}>
                            ...
                            <div className="mt-4 text-right">
                                <Link href={route('project.index')} className="bg-red-600 py-1 px-3 text-white rounded shadow transition-all hover:bg-red-800 mr-2">
                                    Cancel
                                </Link>
