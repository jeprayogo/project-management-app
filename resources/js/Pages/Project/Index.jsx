        ...
        <AuthenticatedLayout
            ...
            header={
                <div className="flex justify-between items-center">
                    ...
                    <Link href={route('project.create')} className="bg-blue-700 py-1 px-3 text-white rounded shadow transition-all hover:bg-blue-900"> Add Project</Link>
                </div>
            }
        >
            <Head title="Projects" />
                ...
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    ...
                    <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                        <div className="p-6 text-gray-900 dark:text-gray-100">
                            ...
                            {/* Tabel untuk data project yang didapat dari controller project*/}
                                    ...
                                    <tbody>
                                        {projects.data.map((project) => (
                                            <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700" key={project.id}>
                                                ...
                                                <th className="px-3 py-2 hover:underline hover:cursor-pointer">
